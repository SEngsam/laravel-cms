                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true"
                                        data-placeholder="Select option" data-dropdown-parent="#kt_menu_624475ed0ca19"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_export_users_form"
                                            action="{{ route('parttners.save') }}" class="form" method="post">
                                            @csrf
                                            <!--begin::Input group-->
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_category_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bolder">Add Parttner</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                            data-kt-users-modal-action="close">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        <!--begin::Form-->
                                        <form class="form" action="{{ route('parttners.save') }}" method="post" enctype="multipart/form-data">
                                          {{ csrf_field() }}
                                            <!--begin::Scroll-->
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-2">Name
                                                        </label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                            <label class="required fw-bold fs-6 mb-2">Logo
                                                     </label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="file" name="logo"
                                                        class="form-control form-control-solid mb-3 mb-lg-0"accept=".png,.jpg,.jpej"
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            @forelse ($parttners as $parttner)
                                ...
                                <img src="{{URL::asset('uploads/parrtner/logo/'. $parttner->logo)}}" >
                                </div>
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td class="min-w-125px text-center" colspan="4"> no results</td>
                                </tr>
                            @endforelse
